    ...
    def __init__(self, llm=None, **kwargs):
        super().__init__(
            ...
            instructions=dedent("""\
                ...
                - Sunk Cost Fallacy: Should past, irrecoverable investments influence future decisions?
                - Decision Tree: Mapping out choices, probabilities, and outcomes.
                - Loss Aversion / Prospect Theory: How does the framing of gains and losses affect choices?
